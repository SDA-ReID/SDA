...
class SoftTripletLoss(nn.Module):
	...
	def __init__(self, margin=None, normalize_feature=False, drop=0):
	...
	def forward(self, emb1, emb2, label):
		if (not self.normalize_feature):
			...
			mat_dist = euclidean_dist(F.normalize(emb1), F.normalize(emb1))
		...
		if (not self.normalize_feature):
			...
			mat_dist_ref = euclidean_dist(F.normalize(emb2), F.normalize(emb2))
