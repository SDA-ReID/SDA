...
def norm_img(imgs, mean=[0.485, 0.456, 0.406], std=[0.229, 0.224, 0.225]):
...
class Evaluator(object):
    ...
    def evaluate(self, data_loader, query, gallery, metric=None, cmc_flag=False, args=None, rerank=False):
